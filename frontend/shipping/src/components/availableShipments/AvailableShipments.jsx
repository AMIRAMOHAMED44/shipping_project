  ...
  return (
    <div className="bg-gray-50">
      <div className="relative bg-[#2E605A] overflow-hidden">
        ...
        <div className="relative container mx-auto px-6 py-24 z-10">
          <div className="max-w-2xl">
            <h1 className="text-4xl font-bold text-white mb-4">Deliver with Confidence</h1>
            <p className="text-xl text-[#c2e0dc] mb-8">
      ...
      <div className="container mx-auto px-6 py-12">
        {availableShipments.length === 0 ? (
          <div className="bg-white p-6 rounded-lg shadow-sm border border-gray-200 text-center">
            ...
            <h3 className="text-lg font-semibold text-gray-800">No Available Shipments</h3>
            <p className="text-gray-500 mt-2">Check back later for new shipment opportunities.</p>
          </div>
        ) : (
          <div className="bg-gray-50 p-6 rounded-lg">
            <div className="mb-6">
              ...
              <p className="text-gray-600 mt-1">Select a shipment to accept and deliver</p>
            </div>
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
              {availableShipments.map((shipment) => (
                <div
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="space-y-4">
                      <div className="flex items-start text-gray-700">
                        <MapPin size={18} className="mr-2 mt-1 text-[#4E9989] flex-shrink-0" />
                        <div>
                          <span className="text-sm text-gray-500">Origin:</span>
                          <p className="font-medium">{shipment.origin}</p>
                        </div>
                      ...
                      <div className="flex items-start text-gray-700">
                        <MapPin size={18} className="mr-2 mt-1 text-[#2E605A] flex-shrink-0" />
                        <div>
                      ...
                      <div className="flex items-center text-gray-700">
                        <Clock size={18} className="mr-2 text-[#4E9989] flex-shrink-0" />
                        <div>
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-lg shadow-sm">
              ...
              <p className="text-gray-600">Guaranteed payments for every completed shipment with transparent tracking.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                <BarChart2 size={24} className="text-[#4E9989] mr-3" />
              ...
              <p className="text-gray-600">Detailed analytics to help you optimize your delivery routes and earnings.</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-sm">
              <div className="flex items-center mb-4">
                <Globe size={24} className="text-[#4E9989] mr-3" />
              ...
              <p className="text-gray-600">Shipments available across multiple cities and regions to maximize your opportunities.</p>
            </div>
          </div>
        </div>
      </div>
